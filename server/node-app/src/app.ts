...
import externalCredentialSyncRoutes from './modules/external-credential-sync/routes';
...
app.use('/admin/external-sync', externalCredentialSyncRoutes); // External credential sync
