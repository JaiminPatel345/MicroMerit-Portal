...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            <section
                className="min-h-[calc(100vh-4rem)] flex relative overflow-hidden bg-gradient-to-br from-white via-blue-chill-50 to-blue-chill-100 py-8 md:py-16">
                {/* Decorative Background Blobs */}
                <div
                    className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
                    <div
                        className="absolute -top-24 -left-24 w-96 h-96 bg-blue-chill-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
                    <div
                        className="absolute top-0 -right-4 w-72 h-72 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
                    <div
                        className="absolute -bottom-8 left-20 w-72 h-72 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
                </div>

                <div
                    className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div
                        className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mt-8 md:mt-12">
                        ...
                        <motion.div {...fadeInUp}
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        className="flex items-center justify-center md:justify-start [&_img]:mx-8 [&_img]:max-w-none animate-infinite-scroll">
                        ...
                        >
                            <div
                                className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 border border-gray-200 ring-1 ring-gray-100 transition-transform duration-500 ease-out">
                                <div
                                    ...
                                    {isLoadingCredentials ? (
                                        ...
                                        latestCredentials.map((cert, i) => {
                                            ...
                                            const hours = issueDate.getHours().
                                                toString().
                                                padStart(2, '0');
                                            const minutes = issueDate.getMinutes().
                                                toString().
                                                padStart(2, '0');
                                            const timeString = `${hours}:${minutes}`;

                                            // Format date
                                            const dateString = issueDate.toLocaleDateString(
                                                'en-GB',
                                                {
                                                    day: '2-digit',
                                                    month: 'short',
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    className="text-xs text-gray-500 bg-gray-50 px-2 py-1 rounded-md font-medium">{timeString} • {dateString}</span>
                                                            </div>
                                        ...
                                        <div className="text-center py-8">
                                            <p className="text-gray-500 text-sm">No
                                                credentials issued yet</p>
                                            <p className="text-xs text-gray-400 mt-1">Be
                                                the first to join!</p>
                                        </div>
                                    )}
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Everything you need to build a trusted, verifiable,
                            and future-ready skill profile.
                        </p>
                    </motion.div>
                  ...
                  `}
                    ...
                    `}>
                                ...
                                <div
                                    className="absolute -bottom-10 -right-10 w-40 h-40 bg-gradient-to-br from-blue-chill-100 to-transparent rounded-full opacity-0 group-hover:opacity-50 transition-opacity duration-500 blur-2xl"></div>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section
                className="py-24 bg-gradient-to-b from-white to-blue-chill-50 relative overflow-hidden">
                {/* Background Elements */}
                <div
                    className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none opacity-30">
                    <div
                        className="absolute top-[20%] left-[10%] w-72 h-72 bg-blue-chill-200 rounded-full blur-3xl mix-blend-multiply animate-blob"></div>
                    <div
                        className="absolute bottom-[20%] right-[10%] w-72 h-72 bg-teal-200 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-2000"></div>
                </div>
                ...
                <div
                    ...
                    <div className="relative">
                        ...
                        <div
                            className="hidden lg:block absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-blue-chill-200 via-blue-chill-400 to-blue-chill-200 -translate-y-1/2 z-0 rounded-full opacity-50"></div>
                        ...
                        <div
                            ...
                            {steps.map((step, index) => (
                                ...
                                >
                                    <div
                                        className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 h-full flex flex-col items-center text-center relative overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border-blue-chill-300">
                                        {/* Step Number Badge */}
                                        <div
                                            className="absolute top-0 right-0 bg-blue-chill-50 text-blue-chill-600 text-xs font-bold px-3 py-1 rounded-bl-xl border-b border-l border-blue-chill-100">
                                            Step {index + 1}
                                        </div>

                                        {/* Icon Circle */}
                                        <div
                                            className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-chill-500 to-blue-chill-700 flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300 text-white ring-4 ring-blue-chill-50">
                                            {step.icon}
                                        </div>
                                        ...
                                        <div
                                            className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-blue-chill-400 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
            ...
            <section
                className="py-16 md:py-24 bg-gradient-to-br from-blue-chill-700 to-blue-chill-900 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div
                        ...
                        >
                            ...
                            <p className="text-lg md:text-xl mb-8 text-blue-chill-200">
                                Instantly map your diverse skill portfolio to
                                the **National Skills Qualifications Framework
                                (NSQF)**. Get personalized, data-driven
                                recommendations to achieve your next skill
                                level.
                            </p>
                            <Link to="/pathway"
                        ...
                        >
                            <div className="mb-6 border-b pb-4 border-gray-100">
                                <h4 className="text-xl md:text-2xl font-bold text-blue-chill-700">My
                                    NSQF Skill Profile</h4>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <div
                                        ...
                                        <span
                                            className="font-bold text-base md:text-lg">NSQF Level 4 Achieved</span>
                                        <span
                                            className="text-blue-chill-600 font-extrabold text-lg md:text-xl">85%</span>
                                    </div>
                                    <div
                                ...
                                <div className="pt-2 space-y-3">
                                    <div
                                        ...
                                        <p className="font-bold text-green-700">Next
                                            Target: NSQF Level 5</p>
                                        <p className="text-sm text-gray-600">Recommended
                                            Course: Certified Data Analyst
                                            (Advanced)</p>
                                    </div>
                                    <div
                                        className="bg-yellow-50 rounded-lg p-4 border-l-4 border-yellow-500">
                                        <p className="font-bold text-yellow-800">Key
                                            Skill Gaps</p>
                                        <p className="text-sm text-gray-700">Advanced
                ...
                <div
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Discover the leading organizations empowering
                            learners and professionals with verifiable
                            credentials.
                        </p>
                    </div>
                    ...
                    {isLoadingIssuers ? (
                        ...
                        <div
                            className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-y-12 gap-x-4 md:gap-x-8">
                ...
                <div
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl mb-10 text-blue-chill-100 max-w-2xl mx-auto leading-relaxed">
                            Ensure the authenticity of skills and achievements.
                            Our blockchain-backed verification guarantees trust
                            and transparency for employers and institutions.
                        </p>
