...
import { forgotPasswordLearner } from '../../services/authServices';
...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await forgotPasswordLearner.start({ email: formData.email });
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link to="/" className="inline-block mb-2">
            <img src={logo} alt={APP_NAME} className="h-20 w-auto mx-auto" />
          </Link>
          <h2 className="text-4xl font-bold text-gray-900 mb-2">Forgot Password?</h2>
          <p className="text-gray-600">No worries! Enter your email and we'll send you a code to reset your password.</p>
        </div>
